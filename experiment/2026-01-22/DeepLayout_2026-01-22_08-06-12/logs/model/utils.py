...
def get_vocab():
    # Updated vocabulary after balcony removal - matches actual data indices: [0, 1, 2, 3, 15]
    # Data has sparse indices, so we remap to contiguous 0-4 for efficient embeddings
